...
fake_ip = 'NASA.gov'
fakeip = '29.80.32.56.98.34.29'
fake_ip = "ZeysScrty D0S"
fakeip = "ZeysScrty D0S"
...
def tcp():
	...
	while True:
		try:
			...
			s.close()
			print("\033[1;31;40m Gta %s Samp %s"%(ip,port))
